...
from kiota_abstractions.api_client_builder import (
    register_default_deserializer, register_default_serializer)
from kiota_abstractions.base_request_builder import BaseRequestBuilder
from kiota_abstractions.request_adapter import RequestAdapter
from kiota_serialization_form.form_parse_node_factory import \
...
class ApiClient(BaseRequestBuilder):
    ...
    def __init__(self, request_adapter: RequestAdapter) -> None:
        ...
        if not self.request_adapter.base_url:
            self.request_adapter.base_url = "https://hub.docker.com"
